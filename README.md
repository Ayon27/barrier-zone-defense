...
This repository provides the PyTorch implementation for the Barrier Zone (BARZ) defense system, as described in the paper: [Barrier Zones for Adversarial Example Defense](https://ieeexplore.ieee.org/document/9663375).
